...
{
    public class GasolineTankExceededMaxCapacityException : Exception
    {
        ...
        public GasolineTankExceededMaxCapacityException(
            ...
            : base(
                string.Format(
                    "Error: Adding {0} Liters of Gasoline to Tank yields {1} which exceeds the Max Capacity of {2} Liters", 
                    i_AmountOfGasolineToAdd,
                    i_CurrentAmountOfGasoline + i_AmountOfGasolineToAdd,
                    i_MaximumGasolineTankCapacity))
        {
